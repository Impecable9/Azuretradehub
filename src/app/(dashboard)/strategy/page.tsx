...
const ASSEMBLY_TASKS = [
  {
    task: "Cortar MDF 8mm a 780×390mm",
    who: "tú",
    time: "2 min",
    tool: "Sierra / proveedor corta a medida",
    skippable: false,
    note: "Sin perforar. MDF plano estándar, más barato y más rápido que el perforado.",
  },
  {
    task: "Aplicar chapa magnética con VHB 3M",
    who: "tú",
    time: "5 min",
    tool: "Rodillo de presión + VHB 3M",
    skippable: false,
    note: "La chapa hace de base magnética. Los imanes se auto-alinean a ella durante el epoxy. Más resistente que agujeros.",
  },
  {
    task: "Colocar molde posicionador (Bambu, 30mm grid)",
    who: "tú",
    time: "2 min",
    tool: "Molde PLA impreso en Bambu",
    skippable: false,
    note: "El molde tiene 336 huecos D5 a 30mm. Se fabrica una sola vez (~€5 filamento). Reutilizable.",
  },
  {
    task: "Depositar 336 imanes en el molde",
    who: "tú",
    time: "10 min",
    tool: "Manual (se auto-alinean por magnetismo)",
    skippable: false,
    note: "Los imanes se pegan solos a la chapa a través de los huecos del molde. Posicionamiento perfecto sin esfuerzo.",
  },
  {
    task: "Aplicar epoxy rápido + curado",
    who: "tú",
    time: "20 min",
    tool: "Pistola epoxy biquomponente 5 min",
    skippable: false,
...
const DELIVERY_MODES = [
  {
    mode: "Kit Fabricado",
    desc: "Tú fabricas el tablero (chapa+imanes+NFC con molde Bambu). Cliente monta el marco SEG y cuelga.",
    youDo: ["MDF 8mm + chapa VHB", "Molde Bambu → 336 imanes", "Epoxy 5 min", "NFC + VHB tela"],
    clientDoes: ["Montar perfil SEG", "Insertar tela", "Colgar"],
    timeYou: "~50 min/panel",
    includeGuide: true,
    margin: "+€7–15 vs modo ensamblado",
    recommended: true,
    note: "Sin taladro. El molde impreso en Bambu hace que los imanes queden perfectos solos. El marco lo monta el cliente en 15 min con guía.",
  },
  {
    mode: "Listo para Colgar",
    desc: "Todo montado y probado. El cliente solo cuelga el sistema.",
    youDo: ["MDF + chapa + imanes (molde)", "NFC", "Montar perfil SEG", "Insertar tela"],
    clientDoes: ["Colgar (10 min)"],
    timeYou: "~75 min/panel",
    includeGuide: false,
